...
Our Company will treat any personal information that you submit through this site in accordance with its Privacy Policy as set forth on this site.
    ...
    <div class="container mb-4">
        <h3 class="text-dark font-weight-bold heading">Disclaimer</h3>
            <h5 class="text-dark font-weight-normal xs_texts">You understand that our Company cannot and does not guarantee or warrant that files available for downloading from the Internet will be free of viruses, worms, Trojan horses or other code that may manifest contaminating or destructive properties. You are responsible for implementing sufficient procedures and checkpoints to satisfy your particular requirements for accuracy of data input and output, and for maintaining a means external to this site for the reconstruction of any lost data. Our Company does not assume any responsibility or risk for your use of the Internet.

The Content is not necessarily complete and up-to-date and should not be used to replace any written reports, statements, or notices provided by Company. Investors, borrowers, and other persons should use the Content in the same manner as any other educational medium and should not rely on the Content to the exclusion of their own professional judgment. Information obtained by using this site is not exhaustive and does not cover all issues, topics, or facts that may be relevant to your goals.<br /><b>YOUR USE OF THIS SITE IS AT YOUR OWN RISK. The Content is provided "as is" and without warranties of any kind, either expressed or implied. Our Company disclaims all warranties, including any implied warranties of merchantability, fitness for a particular purpose, TITLE, OR NON-INFRINGEMENT. Our Company does not warrant that the functions OR CONTENT contained in this site will be uninterrupted or error-free, that defects will be corrected, or that this site or the server that makes it available are free of viruses or other harmful components. Our Company does not warrant or make any representation regarding use, or the result of use, of the content in terms of accuracy, reliability, or otherwise. The content may include technical inaccuracies or typographical errors, and Company may make changes or improvements at any time. You, and not our Company, assume the entire cost of all necessary servicing, repair or correction IN THE EVENT OF ANY LOSS OR DAMAGE ARISING FROM THE USE OF THIS SITE OR ITS CONTENT. Our COMPANY MAKES NO WARRANTIES THAT YOUR USE OF THE CONTENT WILL NOT INFRINGE THE RIGHTS OF OTHERS AND ASSUMES NO LIABILITY OR RESPONSIBILITY FOR ERRORS OR OMISSIONS IN SUCH CONTENT.</b><br />All of the information in this site, whether historical in nature or forward-looking, speaks only as of the date the information is posted on this site, and Company does not undertake any obligation to update such information after it is posted or to remove such information from this site if it is not, or is no longer, accurate or complete.
</h5><br />
        </div>
        
        
    <div class="container mb-4">
        <h3 class="text-dark font-weight-bold heading">Limitation On Liability</h3>
            <h5 class="text-dark font-weight-bold xs_texts">COMPANY, ITS SUBSIDIARIES, AFFILIATES, LICENSORS, SERVICE PROVIDERS, CONTENT PROVIDERS, EMPLOYEES, AGENTS, OFFICERS, AND DIRECTORS WILL NOT BE LIABLE FOR ANY INCIDENTAL, DIRECT, INDIRECT, PUNITIVE, ACTUAL, CONSEQUENTIAL, SPECIAL, EXEMPLARY, OR OTHER DAMAGES, INCLUDING LOSS OF REVENUE OR INCOME, PAIN AND SUFFERING, EMOTIONAL DISTRESS, OR SIMILAR DAMAGES, EVEN IF COMPANY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. IN NO EVENT WILL THE COLLECTIVE LIABILITY OF COMPANY AND ITS SUBSIDIARIES, AFFILIATES, LICENSORS, SERVICE PROVIDERS, CONTENT PROVIDERS, EMPLOYEES, AGENTS, OFFICERS, AND DIRECTORS, TO ANY PARTY (REGARDLESS OF THE FORM OF ACTION, WHETHER IN CONTRACT, TORT, OR OTHERWISE) EXCEED THE GREATER OF $100 OR THE AMOUNT YOU HAVE PAID TO COMPANY FOR THE APPLICABLE CONTENT, PRODUCT OR SERVICE OUT OF WHICH LIABILITY AROSE.
</h5><br />
        </div>
    ...
    <div class="container mb-4">
        <h3 class="text-dark font-weight-bold heading">Indemnity</h3>
            <h5 class="text-dark font-weight-normal xs_texts">You will indemnify and hold Company, its subsidiaries, affiliates, licensors, content providers, service providers, employees, agents, officers, directors, and contractors (hereinafter known as the "Indemnified Parties") harmless from any breach of these Terms of Use by you, including any use of Content other than as expressly authorized in these Terms of Use. You agree that the Indemnified Parties will have no liability in connection with any such breach or unauthorized use, and you agree to indemnify any and all resulting loss, damages, judgments, awards, costs, expenses, and attorney's fees of the Indemnified Parties in connection therewith. You will also indemnify and hold the Indemnified Parties harmless from and against any claims brought by third parties arising out of your use of the information accessed from this site.
</h5><br />
        </div>
        
        
    <div class="container mb-4">
        <h3 class="text-dark font-weight-bold heading">Trademarks</h3>
            <h5 class="text-dark font-weight-normal xs_texts">Trademarks, service marks, and logos appearing in this site are the property of Company or the party that provided the trademarks, service marks, and logos to Company. Company and any party that provided trademarks, service marks, and logos to Company retain all rights with respect to any of their respective trademarks, service marks, and logos appearing in this site.
</h5><br />
    </div> 
    
    <div class="container mb-4">
        <h3 class="text-dark font-weight-bold heading">Security</h3>
            <h5 class="text-dark font-weight-normal xs_texts">Any passwords used for this site are for individual use only. You will be responsible for the security of your password (if any). Company will be entitled to monitor your password and, at its discretion, require you to change it. If you use a password that Company considers insecure, Company will be entitled to require the password to be changed and/or terminate your account.
