...
<div class="aboutUs_bg">
	<h1 class="xl_heading text-white" style="padding-top:200px; padding-left:30px;">About Us</h1>
</div>

<div class="container-fluid pt-5 pb-5 row">

    <div class="col-lg-7 col-md-7 col-sm-12 col-12 ">
        <h1 class="xl_heading text-dark font-weight-bold" style="padding-left:30px;">Who We Are</h1>
        <p class="texts font-weight-normal text-dark p-4" style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;">
    ...
    <div class="ser_border">
        <div class="d-block m-auto xl_heading">Mission & Vision</div>
        <hr />
        <div class="">
            <p class="heading font-weight-bold text-dark font-weight-normal">Our Vision</p>
            <p class="container xs_texts text-dark font-weight-normal ">
        ...
        <div class="">
            <p class="heading font-weight-bold text-dark">Our Mission</p>
            <p class="container xs_texts text-dark font-weight-normal">
        ...
        <div class="">
            <p class="heading font-weight-bold text-dark">Our Values</p>
            <p class="container xs_texts text-dark font-weight-normal">
