...
Your privacy is very important to us. Accordingly, we have developed this Policy in order for you to understand how we collect, use, communicate and disclose and make use of personal information. We use your Personal Information only for providing and improving the website. By using the website, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible at https://affordablelegalhelp.com. The following outlines our privacy policy.
            ...
            <div class="container mb-4">
                <ul class="xs_texts font-weight-normal  pl-2">
                    <li>
            ...
            <div class="container mb-4">
                ...
                <h5 class="text-dark font-weight-normal xs_texts">"Non Personal Information" is information that is not personally identifiable to you and that we automatically collect when you access our Website with a web browser. It may also include publicly available information that is shared between you and others.
"Personally Identifiable Information" is non-public information that is personally identifiable to you and obtained in order for us to provide you our Website. Personally Identifiable Information may include information such as your name, email address, and other related information that you provide to us or that we obtain about you.
            ...
            <div class="container mb-4">
                <h3 class="text-dark font-weight-bold heading">Information We Collect</h3>
                <h5 class="text-dark font-weight-normal xs_texts">Generally, you control the amount and type of information you provide to us when using our Website.
As a Visitor, you can browse our website to find out more about our Website. You are not required to provide us with any Personally Identifiable Information as a Visitor.
            ...
            <div class="container mb-4">
                <h3 class="text-dark font-weight-bold heading">Computer Information Collected</h3>
                <h5 class="text-dark font-weight-normal xs_texts">When you use our Website, we automatically collect certain computer information by the interaction of your mobile phone or web browser with our Website. Such information is typically considered Non Personal Information. We also collect the following:</h5>
                
            </div>
            
            <div class="container mb-4">
                    <ul class="xs_texts font-weight-normal mt-2 pl-2">
                        <li>
