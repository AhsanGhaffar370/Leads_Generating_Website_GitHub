<footer class="text-light text-center container-fluid xxs_texts" style="background-color: #1c1c1c;" >
    ...
    <div class="pt-4 pb-4">
        ...
        <a href="terms-of-use" class="pr-4 text-white font-weight-bold" >Terms Of Use</a>
        <a href="contact-us" class="pr-4 text-white font-weight-bold" >ContactUs</a>
