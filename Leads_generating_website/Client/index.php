...
<script async src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js">
</script>
...
<section class="ser_top" id="fill">
    <div class="container-fluid "><!--div 0 -->
        ...
        <h1 class="pt-5 pl-0 pr-0 mt-2 mb-3 search_heading_settings text-white xl_heading font-weight-bold col-12 col-lg-11 col-md-11 col-sm-12  ">With Affordable Legal Help, You Can Hire A Lawyer To Help You With Your Case For As Low As $500‑$1500.</h1>
        <h1 class="mt-5 mb-5 pl-0 pr-0 search_heading_settings text-white xl_heading font-weight-normal col-12 col-lg-9 col-md-10 col-sm-11">Enter Your city or zipcode to connect with a lawyer in your local area for a free consultation!</h1>
        ...
        <br>
        <form class="ser_state mt-3" method="post" ><!--form a -->
            ...
            <div class="col-10 pr-0 pl-0"><!--div a -->
            	...
            	<div class="row">
                    ...
                    <div class="col-12 col-lg-8 col-md-8 col-sm-12">
                        <input type="text" name="country" id="country" class="form-control heading ser_box mt-2"  placeholder="Enter Your City Or Zipcode" autocomplete="off" style="border-radius:45px;"/>
                        
                        <div style=" position: absolute; width:100%; padding-left: 2rem !important; padding-right: 4rem !important;">
                    ...
                    <div class="col-12 col-lg-4 col-md-4 col-sm-12 " style="position: inherit;">
                        <div  id="btnconnect"><!--div c -->
                            <input type="submit" name="submitbtn" id="btns" value="Connect With Lawyer" class="btn font-weight-bold button_size ser_btn mt-2" style="border-radius:45px;"/>
                        </div><!--div c -->
                    </div>
...
<hr class="pt-0 mt-0 bg-dark" style="border-top: 10px solid rgba(20, 30, 87,1);" />
</center>
...
<section class="container-fluid text-center p-4 mt-5">
	<h1 class=" home_heading_settings font-weight-bold jl_heading">How It Works</h1>

    <div class="row mt-3 text-center">
    
        <div class="col-lg-4 col-md-4 col-sm-12 col-12 mt-4">
        	<i class="fas fa-check-circle fa-4x"></i>
            <h3 class="mt-3 home_heading_settings font-weight-bold xl_heading">Complete Request</h3>
            <p class="text-dark font-weight-normal texts">Your Consultation is free and confidential</p>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12 col-12 mt-4">
        	<i class="fas fa-link fa-4x"></i>
            <h3 class="mt-3 home_heading_settings font-weight-bold xl_heading">Instantly Connect</h3>
            <p class="text-dark font-weight-normal texts">Talk to an unbunduled attorney in minutes</p>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12 col-12 mt-4">
        	<i class="fas fa-hand-holding-usd fa-4x"></i>
            <h3 class="mt-3 home_heading_settings font-weight-bold xl_heading">Save Money</h3>
            <p class="text-dark font-weight-normal texts">You Only Pay for the legal help you need</p>
        </div>
