        ...
        <form class="lawyer-form1 p-4 text-left" method="post" >
            ...
            <div class="form-group">
                ...
                <select name="state" class="form-control" id="state">
                        ...
                        <option value="Alabama(AL),Huntsville">Alabama(AL)</option>
                        <option value="Alaska (AK),Anchorage">Alaska (AK)</option>
                        <option value="Arizona (AZ),Phoenix">Arizona (AZ) </option>
                        <option value="California(CA),Los Angeles">California(CA)</option>
                        <option value="Colorado (CO),Denver">Colorado (CO)</option>
                        <option value="Conneticut (CT),Hartford">Conneticut (CT) </option>
                        <option value="Georgia (GA),Atlanta">Georgia (GA) </option>
                        <option value="Hawaii (HI),Honolulu">Hawaii (HI) </option>
                        <option value="Idaho (ID),Montpelier">Idaho (ID) </option>
                        <option value="Illinois (IL),Chicago">Illinois (IL) </option>
                 </select>
            </div>
