...
<head>
    ...
    <title>About us | Affordable Legal Help</title>
...
<style>
    ...
    .stories_bg{
    background-image: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url("Image/f1.jpg");  
}
...
<div class="jumbotron jumbotron-fluid bg1 stories_bg d-flex align-items-center border-0">
    <div class="container">
        <h1 class="size46 font-weight-normal text-white text-left" style="font-family: 'Montserrat', sans-serif;">ABOUT US</h1>
        <hr align="left" class="m-0 col-4 col-lg-2 col-md-3 col-sm-3" style="border: 3px solid rgba(0, 81, 152); border-radius: 2px;" />
    </div>
</div>
...
<div class="container-fluid pt-5 pb-5 pr-0 pl-0 m-0 row">
    ...
    <div class="col-lg-7 col-md-7 col-sm-12 col-12 ">
        ...
        <p class="font-weight-normal text-dark p-4" style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;">
    ...
    <div class="ser_border pr-0 mr-0">
        ...
        <hr />
        <div class="">
            <h4 class="font-weight-bold text-dark font-weight-normal">Our Vision</h4>
            <p class="container text-dark font-weight-normal ">
