...
// } 
$sqq ="select meta_desc,post_title from posts where post_url='$page_id' ";
                ...
                if($quey->rowCount() > 0)
                {
                    foreach($resu as $resul){
                      $title =htmlentities($resul->post_title);
...
<div class="jumbotron jumbotron-fluid bg1 blog_bg border-0">
    <div class="paddings">
        <p class="size46 text-white text-center ">OUR BLOGS</p>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-md-12 col-sm-12 col-12 d-block">
			...
			<div id="main_content" class="mb-5 mt-3">
                ...
                <h1 class="font_meri mt-5"><?php echo $post_title; ?></h1>
