...
.faq1{
    background-image: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url("../Image/agent.png");
...
<div class="jumbotron jumbotron-fluid faq1 d-flex align-items-center border-0">
    <div class="container">

    <h1 class="jl_heading font-weight-bold text-white text-center" >Frequently Ask Questions</h1>
            ...
            <div class="card border-0 bg-white flex-fill" style="box-shadow: 0px 0px 5px 0px #CCCCCC;">
                ...
                <div class="card-body">
                    <div class="card-title">
                        <h5 class="font-weight-normal text-left"  style="font-size:20px;">
                            How Unbundled Legal Services Benefit Divorce Cases?
                        </h5>
                    </div>
                    <p class="card-text text-black-50 text-left"  style='font-size:16px;'>
