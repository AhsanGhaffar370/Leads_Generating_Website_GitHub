...
include_once "balance_status.php";
session_start();
error_reporting(0);
...
<section class="pl-2 pr-2">
    <div class="container bg-white text-center text-black dash pt-2 mt-5 mb-5 border-light border-right border-left border-top border-bottom">
        ...
        <h4 class="text-left pl-5 font-weight-bold p-3 mt-5" style="background-color:#d1ecf1; color:#0c5460;">Add cities </h4>
        
        <div class="container">
        <!-- <?php echo $pending; ?>
        <?php if ($active==0){echo "Pause";}
    								else{echo "Active";}?> -->
