...
<head>
    ...
    <title>Add city | Affordable Attorney leads</title>
...
<section class="pl-2 pr-2">
    <div class="container bg-white text-center text-black dash pt-2 mt-5 mb-5 border-light border-right border-left border-top border-bottom">
        ...
        <div class="col-12 col-lg-6 col-md-8 col-sm-8">
            <div class="alert alert-primary mb-4 texts container font-weight-normal text-dark">
                <!--<i class="fas fa-info-circle text-info"> </i>-->
                Please call us at 844 944 5342 to check the availability of leads in your local area. After consultation we will start delivering leads to you.
            </div>
        </div>
        <div class="container">
