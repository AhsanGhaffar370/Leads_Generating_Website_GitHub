...
<section class="container bg-white text-center text-black dash pt-2 mt-5 mb-5 border-light border-right border-left border-top border-bottom">
    ...
    <h4 class="text-left pl-5 font-weight-bold p-3" style="background-color:#d1ecf1; color:#0c5460;">REPORT </h4>
            ...
            <?php if($error){?>
                ...
                <form class="payment-form1" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                            <input type="submit" name="update" id="update" class="btn p-2 btn-sm mb-5 buttons font-weight-bold button_size" value="Submit" />
                    </div>
                </form>
            </div>
        </center>
