            ...
            <div class="col-12 col-lg-7  col-md-10 col-sm-12">
                ...
                <form class="form1"  method="post" >
                    ...
                    <div class="form-group text-left">
                        <label class="mt-3">Your City:</label>
                        <div class="row">
                            <div class="col-12 col-lg-11 col-md-11 col-sm-12  pr-0 pl-0">
                                <input type="text" name="country" id="country"  value="<?php if ($state=="Dayton,OH"){
                                    echo "Dayton,OH";
                                }else if($state=="Cleveland,OH"){
                                    echo "Cleveland,OH";
                                }
                                else if ($state=="Cincinnati,OH"){
                                    echo "Cincinnati,OH";
                                }
                                else if($state=="Columbus,OH"){
                                    echo "Columbus,OH";
                                }
                                 ?>"
                    ...
                    <div class="form-group text-left div1 ">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-11 col-md-11 col-sm-12  pr-0 pl-0">
                                <input type="text" name="country" id="country1"  value="<?php if ($city2=="Dayton,OH"){
                                    echo "Dayton,OH";
                                }else if($city2=="Cleveland,OH"){
                                    echo "Cleveland,OH";
                                }
                                else if ($city2=="Cincinnati,OH"){
                                    echo "Cincinnati,OH";
                                }
                                else if($city2=="Columbus,OH"){
                                    echo "Columbus,OH";
                                }
                                 ?>"
                    ...
                    <div class="form-group text-left div2">
                        ...
                        <div class="row">
                    	    <div class="col-12 col-lg-11 col-md-11 col-sm-12  pr-0 pl-0">
                                <input type="text" name="country" id="country2"  value="<?php if ($city3=="Dayton,OH"){
                                    echo "Dayton,OH";
                    ...
                    <div class="form-group text-left div3">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-11 col-md-11 col-sm-12  pr-0 pl-0">
                                <input type="text" name="country" id="country3"  value="<?php if ($city4=="Dayton,OH"){
                                    echo "Dayton,OH";
