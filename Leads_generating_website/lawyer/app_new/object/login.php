...
class Signup{
    ...
    function lawyerSignup(){
        ...
        $query = "INSERT INTO
                    " . $this->table_name . "
                SET
                    Name=:Name,Organization=:Organization, Email=:Email, Password=:Password,Contact=:Contact,state=:state,Zipcode=:Zipcode,timezone=:timezone";
        ...
        function lawyerSignIn()
        {
                ...
                if($query->rowCount() > 0)
                {
                    foreach($results as $result){
                        ...
                        $_SESSION['Catogory2']=htmlentities($result->Catogory2);
                        $_SESSION['Catogory3']=htmlentities($result->Catogory3);
                        $_SESSION['Catogory4']=htmlentities($result->Catogory4);
