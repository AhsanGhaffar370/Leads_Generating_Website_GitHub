    ...
    <div class="container bg-white law_services text-center text-black pt-1 pb-5" style="margin-top:130px;">
        ...
        <div class="container  ">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12 d-block mb-3">
                    ...
                    <div class="card set_img card h-100">
                        <div class="m-4">
                            ...
                            <p class="text-dark text-center font-weight-bold m-0">Your zipcodes</p>
                        </div>
                    </div>
                    </a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-12 d-block mb-3">
                    ...
                    <div class="card set_img card h-100">
                        <div class="m-4">
                            ...
                            <p class="text-dark text-center font-weight-bold m-0">Report Lead</p>
                        </div>
                    </div>
                    </a>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12 d-block mb-3">
                	<a href="https://affordableattorneyleads.com/add-card/" class="nav-link">
                    <div class="card set_img">
                        <div class="m-4">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12 d-block mb-3">
                	<a href="autoresponder" class="nav-link">
                    <div class="card set_img">
                        <div class="m-4">
