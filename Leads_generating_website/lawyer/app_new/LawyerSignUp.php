...
<?php
    ...
    if (isset($_POST['submitbtn']))
    {
        ...
        $sign_up->timezone=$_POST['timezone'];
	...
	<div class="col-lg-6 col-md-8 col-sm-10 pt-2 pb-4 pl-3 pr-3 bg-light">
        ...
        <form class="lawyer-form1 text-left" method="post" >
            <div class="form-group ">
                ...
                <input type="text" class="form-control p-4" name="fname" id="fname"  placeholder="Full Name" required/> 
            </div>
            <div class="form-group ">
                <label class="mb-0">Organization</label>
                <input type="text" class="form-control p-4" name="organ" id="organ"  placeholder="Organization" required/> 
            </div>
            
            <div class="form-group">
                <label class="mb-0">Email:</label>
                <input type="text" class="form-control p-4" name="email" id="email" placeholder="Email Address" required/>
            </div>
            
            <div class="form-group">
                <label class="mb-0">Phone:</label>
                <input type="tel" class="form-control p-4" name="mob" id="mob" placeholder="Phone" required/>
            </div>
            
            <div class="form-group">
                <label class="mb-0">Timezone:</label>
                <select name="timezone" class="form-control" id="state" required>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control p-4" name="zip" id="zip" placeholder="Zip Code" required/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control p-4" name="pass" id="pass" placeholder="Password" required/>
            </div>
            
            <div class="form-group">
                
                <input type="checkbox" name="agree" value="agree" required>
                <label class="mb-0">I agree <a href="https://affordableattorneyleads.com/terms-of-use/" >Terms of use</a> and <a href="https://affordableattorneyleads.com/privacy-policy/" >privacy policy</a></label>
            </div>
            
            <div class="form-group text-center">
            	<input type="submit" name="submitbtn" value="SIGNUP" class="button_size btn mt-3 p-3 btn-lg mb-2 btn-danger font-weight-bold"/>
            </div>
